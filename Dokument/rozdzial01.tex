...
\begin{figure}[H]
	...
	\begin{tabular}{@{}ccc@{}}
            a) & b)\\
    \vtop{\null\hbox{\includegraphics[width=0.3\linewidth]{rozdzial1/profil_opinia_m.png}}} &
    \vtop{\null\hbox{\includegraphics[width=0.3\linewidth]{rozdzial1/dodaj_opinie_m.png}}}
    \end{tabular}
...
\begin{figure}[H]
	...
	\begin{tabular}{@{}ccc@{}}
            a) & b)\\
    \vtop{\null\hbox{\includegraphics[width=0.3\linewidth]{rozdzial1/menu_m_zleceniodawca.png}}} &
    \vtop{\null\hbox{\includegraphics[width=0.3\linewidth]{rozdzial1/dodaj_zlecenie_m.png}}}
    \end{tabular}
